...
class ReportApprovalController extends GetxController {
  ...
  Future<bool> confirmData() async {
    Get.dialog(
      RoundedDialog(
        color: Colors.blue,
        title: "Terima Pengajuan Laporan",
        content: "Apakah Anda yakin menerima laporan ini?",
        negativeLabelButton: "Tidak",
        positiveLabelButton: "Yakin dan Terima",
