    ...
    return Scaffold(
      ...
      body: PagedListView<int, ReportRecord>.separated(
        ...
        builderDelegate: PagedChildBuilderDelegate<ReportRecord>(
          ...
          firstPageProgressIndicatorBuilder: (_) => const ShimmerReportCard(),
          newPageProgressIndicatorBuilder: (_) => const ShimmerReportCard(),
...
class ReportCard extends StatelessWidget {
  const ReportCard({super.key, required this.report, this.onClick});
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onTap: report.reportStatus == "diterima" ? onClick : null,
      child: Container(
